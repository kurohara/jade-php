...
module.exports = function (jade) {
    ...
    var exParseCode;
    var exAttrs;
    if (jade.Compiler.prototype.exVisitCode) {
    } else {
        exVisitCode = jade.Compiler.prototype.visitCode;
        exParseCode = jade.Parser.prototype.parseCode;
        exAttrs = jade.Compiler.prototype.attrs;
    }
